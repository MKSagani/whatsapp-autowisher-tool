...
if __name__ == '__main__':
    """To Run this Sotware you have to create wisher.xlsx file to store data and column must be Name, Number,Birthdate,Year"""
    try:
    ...
    for index, item in df.iterrows():
        ...
        if (today == bday) and yearNow not in str(item['Year']):   # check today== bday if yes then send_message
            ...
            send_message(item['Number'], item['Wish'] + ' ' + item['Name'], hr, minute, sec)
